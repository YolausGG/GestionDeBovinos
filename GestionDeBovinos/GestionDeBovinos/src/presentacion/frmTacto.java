 ...
 * @author nico_
 */
public class frmTacto extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTacto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
